...
filter_list <- list(indicator = "Employed total", sex = "Persons", state = params$state, series_type = "Seasonally Adjusted")
...
-   Total *employment* `r filter_list = list(indicator = "Employed total", sex = "Persons", state = "Australia", series_type = "Seasonally Adjusted"); change(labour_force_briefing, filter_with = filter_list, ym = 'month')` people.
...
`r {filter_list = list(indicator = "Employed total", state = params$state, sex = "Persons", series_type = "Seasonally Adjusted")}`
...
abs_plot(labour_force_briefing, filter_with = filter_list, type = "labour_force")
```
...
#| fig-align: center
filter_list$state = params$state
abs_plot(labour_force_briefing, filter_list, type = "labour_force")
```
...
abs_plot(labour_force_briefing, filter_with = filter_list, compare_aus = F, type = "labour_force")
